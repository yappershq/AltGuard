...
/// <summary>
/// Holds engine managers and the cross-plugin interfaces AltGuard consumes. Optional interfaces
...
internal sealed class InterfaceBridge
{
    ...
    internal IAdminOperationStorageService? BanStorage     { get; private set; }
    ...
    internal void ResolveModules()
    {
        ...
        BanStorage = SharpModuleManager
            .GetOptionalSharpModuleInterface<IAdminOperationStorageService>(IAdminOperationStorageService.Identity)?.Instance;
